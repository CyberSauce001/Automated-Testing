...
data = sys.argv[1]
if data == 'firefox':
    log = open('LogFile/Stage_Scorm_FireFox_Log.txt', 'w')
    error = open('LogFile/Stage_Scorm_FireFox_Error.txt', 'w')
if data == 'chrome':
    log = open('LogFile/Stage_Scorm_Chrome_Log.txt', 'w')
    error = open('LogFile/Stage_Scorm_Chrome_Error.txt', 'w')
...
def scormtest(arg):
    ...
    log.close()
    error.close()
    if os.stat('LogFile/Stage_Scorm_FireFox__Log.txt').st_size == 0 :
        os.remove('LogFile/Stage_Scorm_FireFox__Log.txt')
        os.remove('/LogFile/Stage_Scorm_FireFox__Error.txt')
    if os.stat('LogFile/Stage_Scorm_Chrome_Log.txt').st_size == 0 :
        os.remove('LogFile/Stage_Scorm_Chrome_Log.txt')
        os.remove('LogFile/Stage_Scorm_Chrome_Error.txt')
    driver.quit()
